...
declare class DataModel extends ServiceProvider
    ...
    function HttpGet(self, url: string, async: boolean?): string
    function HttpGetAsync(self, url: string): string
    function GetObjects(self, id: string): { any }
end
...
declare function setfflag(name: string, value: string): ()
declare function getfflag(name: string): string
declare function setfpscap(fps: number): ()
declare function getfpscap(): number
declare function fireclickdetector(click_detector: ClickDetector, distance: number?): ()
declare function fireproximityprompt(proximity_prompt: ProximityPrompt): ()
declare function firetouchinterest(sender: Instance, receiver: Instance, touch: boolean | number): ()
declare function queueonteleport(source: string): ()
declare queue_on_teleport: typeof(queueonteleport)
declare queueteleport: typeof(queueonteleport)

declare function clearqueueonteleport(): ()
declare clear_teleport_queue: typeof(clearqueueonteleport)
...
-- Closure Library
declare function isexecutorclosure(closure: (...any) -> ...any): boolean
declare checkclosure: typeof(isexecutorclosure)
declare isourclosure: typeof(isexecutorclosure)

declare function isnewcclosure(closure: (...any) -> ...any): boolean
declare iscustomcclosure: typeof(isnewcclosure)

declare function clonefunction<A..., R...>(closure: (A...) -> R...): (A...) -> R...
declare function newcclosure<A..., R...>(closure: (A...) -> R..., name: string): (A...) -> R...
declare function newlclosure<A..., R...>(closure: (A...) -> R..., name: string): (A...) -> R...
declare function getfunctionhash(closure: (...any) -> ...any): string
...
declare class CircleDrawingObject extends DrawingObject
    NumSides: number
    Radius: number
    Position: Vector2
    Thickness: number
...
declare class ImageDrawingObject extends DrawingObject
    Data: string
    Size: Vector2
    Position: Vector2
    Rounding: number
...
declare class LineDrawingObject extends DrawingObject
    From: Vector2
    To: Vector2
    Thickness: number
end

declare class QuadDrawingObject extends DrawingObject
    PointA: Vector2
    PointB: Vector2
    PointC: Vector2
    PointD: Vector2
...
declare class SquareDrawingObject extends DrawingObject
    Size: Vector2
    Position: Vector2
    Thickness: number
    Filled: boolean
...
declare class TextDrawingObject extends DrawingObject
    Text: string
    TextBounds: Vector2
...
declare class TriangleDrawingObject extends DrawingObject
    PointA: Vector2
    PointB: Vector2
    Thickness: number
    Filled: boolean
...
declare function isrenderobj(drawing_object: any): boolean
declare function getrenderproperty(drawing_object: DrawingObject, property: string): any
declare function setrenderproperty(drawing_object: DrawingObject, property: string, value: any): ()
...
declare class DrawFont
	function GetTextBounds(self, size: number, text: string): Vector2
end

declare DrawFont: {
	Register: ((font_data: string, options: DrawFontOptions) -> DrawFont)
}
...
declare Drawing: {
	new: (
        ((drawing_type: "Circle") -> CircleDrawingObject) & 
        ((drawing_type: "Image") -> ImageDrawingObject) & 
        ((drawing_type: "Line") -> LineDrawingObject) & 
        ((drawing_type: "Quad") -> QuadDrawingObject) & 
        ((drawing_type: "Square") -> SquareDrawingObject) & 
        ((drawing_type: "Text") -> TextDrawingObject) & 
        ((drawing_type: "Triangle") -> TriangleDrawingObject)),
	Fonts: DrawingFonts
}

-- GC Library
declare getgc: (
	((include_tables: false?) -> { ((...any) -> ...any) })) &
    ((include_tables: true) -> { ((...any) -> ...any) | { any } | typeof(newproxy(false)) | thread })
...
declare filtergc: (
    ((filter_type: "function", filter_options: FunctionFilterOptions, return_one: true) -> ((...any) -> ...any)?) &
    ((filter_type: "table", filter_options: TableFilterOptions, return_one: true) -> ({ [any]: any })?) &
    ((filter_type: "function", filter_options: FunctionFilterOptions, return_one: false) -> { (...any) -> ...any }) &
    ((filter_type: "table", filter_options: TableFilterOptions, return_one: false) -> { { [any]: any } }))

-- Hooking Library
declare function hookfunction<A1..., R1...>(function_to_hook: (A1...) -> R1..., hook: (...any) -> ...any): (A1...) -> R1...
declare replaceclosure: typeof(hookfunction)
declare hookfunc: typeof(hookfunction)

declare function hookmetamethod(object: any, metamethod: string, hook: (...any) -> ...any): (...any) -> ...any
declare function restorefunction(function_to_restore: (...any) -> ...any): ()
declare restorefunc: typeof(restorefunction)

declare function isfunctionhooked(function_to_check: (...any) -> ...any): boolean


-- Spoofing Library
declare function setstackhidden(function_to_hide: ((...any) -> ...any) | number, hidden: boolean): ()


-- VoltSignal Library
declare class VoltConnection
	Connected: boolean
	function Disconnect(self): ()
end

export type VoltSignal<T... = ...any> = {
	Connect: (self: VoltSignal<T...>, callback: (T...) -> ()) -> VoltConnection,
	Once: (self: VoltSignal<T...>, callback: (T...) -> ()) -> VoltConnection,
	Wait: (self: VoltSignal<T...>) -> T...,
	Fire: (self: VoltSignal<T...>, T...) -> ()
}
...
declare function run_on_actor(actor: Actor, source: string, ...: any): ()
declare function isparallel(): boolean
declare function get_comm_channel(comm_channel_id: number): BindableEvent
declare function create_comm_channel(): (number, BindableEvent)
declare function get_current_actor(): Actor?

declare on_actor_state_created: VoltSignal<Actor>

-- Cache Library
declare cache: {
	replace: ((old: Instance, new: Instance) -> ()),
    invalidate: ((instance: Instance) -> ()),
    iscached: ((instance: Instance) -> boolean),
}

declare function cloneref<T>(instance: T & Instance): T
declare clonereference: typeof(cloneref)
declare function compareinstances(lhs: Instance, rhs: Instance): boolean
...
declare get_signal_cons: typeof(getconnections)
...
declare function getsignalwhitelist(signal: RBXScriptSignal): { { Event: string?, Parent: string? } }
declare function getsignalargumentsinfo(signal: RBXScriptSignal): { { Name: string?, Type: string? } }


-- Console Library
declare function rconsoleshow(): ()
declare rconsolecreate: typeof(rconsoleshow)
declare consolecreate: typeof(rconsoleshow)

declare function rconsolehide(): ()
declare rconsoledestroy: typeof(rconsolehide)
declare consoledestroy: typeof(rconsolehide)

declare function rconsoletoggle(): ()
declare function rconsolehidden(): ()
declare function rconsoletop<T>(top: boolean): ()
declare function rconsoleprint<T>(value: T, async: boolean?, escape: boolean?): ()
declare consoleprint: typeof(rconsoleprint)

declare function rconsoleinfo<T>(value: T, async: boolean?): ()
declare function rconsolewarn<T>(value: T, async: boolean?): ()
declare function rconsoleerr<T>(value: T, async: boolean?): ()
declare function rconsoleclear(): ()
declare consoleclear: typeof(rconsoleclear)

declare function rconsolename(title: string): ()
declare rconsolesettitle: typeof(rconsolename)
declare consolesettitle: typeof(rconsolename)

declare function rconsoleinput(): string
declare consoleinput: typeof(rconsoleinput)


-- Crypt Library
declare function base64_encode(data: string): string
declare base64encode: typeof(base64_encode)
declare function base64_decode(data: string): string
declare base64decode: typeof(base64_decode)

declare function lz4compress(data: string): string
declare function lz4decompress(data: string): string

declare base64: {
	encode: typeof(base64_encode),
    decode: typeof(base64_decode),
}

type hash_algorithm = 
    "sha256" | "md5" | "sha1" | "sha384" | "blake2b" |
...
declare crypt: {
    ...
    base64encode: typeof(base64_encode),
    base64decode: typeof(base64_decode),
    random: ((length: number) -> string),
    hash: ((data: string, algorithm: hash_algorithm) -> string),
    generatekey: (() -> string),
    generatebytes: ((length: number) -> string),
    encrypt: ((data: string, key: string, iv: string?) -> (string, string)),
    decrypt: ((data: string, key: string, iv: string) -> string),
    lz4compress: typeof(lz4compress),
    lz4decompress: typeof(lz4decompress),
    hmac: ((key: string, data: string, algorithm: hash_algorithm) -> string),
...
declare function isreadonly(tab: { any }): boolean
declare function iswriteble(tab: { any }): boolean
declare function makereadonly(tab: { any }): ()
declare function makewritable(tab: { any }): ()
declare function setreadonly(tab: { any }, readonly: boolean | number): ()
...
declare function validlevel(level: number, thread: thread?): boolean
declare isvalidlevel: typeof(validlevel)

declare function getcallstack(thread: thread?): { { func: (...any) -> ...any, currentline: number? } } 
declare getprotos: (((f: (...any) -> ...any) -> { ProtoProxy }) & ((level: number) -> { ProtoProxy }) & ((proto_proxy: ProtoProxy) -> { ProtoProxy }))
declare getproto: (
        ((f: (...any) -> ...any, index: number, active: false) -> ProtoProxy) & 
        ((level: number, index: number, active: false) -> ProtoProxy) & 
        ((proto_proxy: ProtoProxy, index: number, active: false) -> ProtoProxy) &
        ((f: (...any) -> ...any, index: number, active: true) -> { ProtoProxy }) & 
        ((level: number, index: number, active: true) -> { ProtoProxy }) & 
        ((proto_proxy: ProtoProxy, index: number, active: true) -> { ProtoProxy }))
    
declare getstack: (
        ((level: number) -> { any }) &
        ((thread: thread, level: number) -> { any }) &
        ((level: number, index: number) -> any) &
        ((thread: thread, level: number, index: number) -> any))

declare setstack: (
        ((level: number, index: number, value: any) -> ()) &
        ((thread: thread, level: number, index: number, value: any) -> ()))
...
declare getupvalue: (
        ((f: (...any) -> ...any, index: number) -> any) & 
        ((level: number, index: number) -> any))

declare setupvalue: (
        ((f: (...any) -> ...any, index: number, value: any) -> ()) & 
        ((level: number, index: number, value: any) -> ()))

declare getconstants: (
        ((f: (...any) -> ...any) -> { any }) & 
        ((level: number) -> { any }) & 
        ((proto_proxy: ProtoProxy) -> { any }))
        
declare getconstant: (
        ((f: (...any) -> ...any, index: number) -> any) & 
        ((level: number, index: number) -> any) & 
        ((proto_proxy: ProtoProxy, index: number) -> any))

declare setconstant: (
        ((f: (...any) -> ...any, index: number, value: any) -> ()) & 
        ((level: number, index: number, value: any) -> ()) & 
        ((proto_proxy: ProtoProxy, index: number, value: any) -> ()))

export type SetInfoOptions = {
	name: string,
	currentline: number,
	short_src: string,
	source: string,
...
declare setinfo: (
        ((f: (...any) -> ...any, options: SetInfoOptions) -> ()) & 
        ((level: number, options: SetInfoOptions) -> ()) & 
        ((proto_proxy: ProtoProxy, options: SetInfoOptions) -> ()))
        
type GetInfoResult<F> = {
    func: F,
    source: string,
    short_src: string,
    currentline: number,
...
declare getinfo: (
    (<A..., R...>(f: (A...) -> R...) -> GetInfoResult<((A...) -> R...)>) & 
    ((level: number) -> GetInfoResult<((...any) -> ...any)>) & 
    ((proto_proxy: ProtoProxy) -> GetInfoResult<ProtoProxy>))

declare debug: {
	info: (<R...>(thread, number, string) -> R...) & (<R...>(number, string) -> R...) & (<A..., R1..., R2...>((A...) -> R1..., string) -> R2...) & (<R...>(ProtoProxy, string) -> R...),
    ...
    validlevel: typeof(validlevel),
    isvalidlevel: typeof(validlevel),
    getcallstack: typeof(getcallstack),
...
declare function loadfile<A...>(path: string): (((A...) -> any)?, string?)
declare function dofile(path: string): ()
declare runfile: typeof(dofile)
...
declare get_hidden_gui: typeof(gethui)


-- Http Library
export type VoltRequestOptions = {
    Url: string,
...
export type VoltRequestResponse = {
    StatusCode: number,
    StatusMessage: string,
    Headers: { 
        [string]: string
...
declare function request(request_options: VoltRequestOptions): VoltRequestResponse
declare http_request: typeof(request)
...
declare isrbxactive: typeof(iswindowactive)
declare isgameactive: typeof(iswindowactive)

declare function keypress(key: number)
declare keypress: typeof(keypress)
...
-- Reflection Library
declare function getinstancecache(): { Instance }
declare function setthreadidentity(identity: number): ()
declare setthreadcontext: typeof(setthreadidentity)
declare setidentity: typeof(setthreadidentity)
declare set_thread_identity: typeof(setthreadidentity)

declare function getthreadidentity(): number
declare getthreadcontext: typeof(getthreadidentity)
declare getidentity: typeof(getthreadidentity)
declare get_thread_identity: typeof(getthreadidentity)

declare function gethiddenproperty(instance: Instance, propery_name: string): (any, boolean)
declare function sethiddenproperty(instance: Instance, propery_name: string, new_value: any): boolean
...
declare getcallbackmember: (
	((instance: Instance, property_name: string, return_raw: false?) -> ((...any) -> ...any)?) &
	((instance: Instance, property_name: string, return_raw: true) -> any))
declare getcallbackvalue: typeof(getcallbackmember)

declare function setscriptable(instance: Instance, propery_name: string, scriptable: boolean): boolean
declare function isscriptable(instance: Instance, propery_name: string): boolean
declare function isnetworkowner(instance: Instance): boolean
declare function getrendersteppedlist(): { { Function: ((...any) -> ...any)?, Thread: thread?, Name: string, Priority: number } }


--
export type VoltSaveInstanceOptions = {
    FileName: string,
...
declare function saveinstance(instance: Instance?, options: VoltSaveInstanceOptions?): boolean
declare function saveplace(options: VoltSaveInstanceOptions): boolean


-- Script Library
declare function getcallingscript(): BaseScript?
declare function getscriptfromthread(thread: thread): BaseScript?
declare function loadstring<A...>(src: string, chunkname: string?): (((A...) -> any)?, string?)
declare function islclosure(closure: (...any) -> ...any): boolean
declare function iscclosure(closure: (...any) -> ...any): boolean
declare function getsenv(script: BaseScript): { [any]: any }
declare function getscriptbytecode(script: BaseScript): string
declare dumpstring: typeof(getscriptbytecode)
...
declare function lift_closure(closure: (...any) -> ...any): string
declare function getrunningscripts(): { BaseScript }
declare function getscripts(): { BaseScript }
declare function getmodules(): { ModuleScript }
...
-- WebSocketClient (VoltWebSocketClient due to existing WebSocketClient class)
declare class VoltWebSocketClient
    IsClosed: boolean
    OnMessage: VoltSignal<string>
    OnClose: VoltSignal<()>

    function Send(self, data: string, is_binary: boolean?): ()
    function Close(self): ()
end

declare WebSocket: {
    connect: ((url: string) -> VoltWebSocketClient),
}
...
-- Windows Library
declare function setclipboard(data: string): ()
...
-- Oth Library
declare oth: {
	hook: (<A1..., R1...>(target: (A1...) -> R1..., hook: (...any) -> ...any) -> (A1...) -> R1...),
	unhook: (<A1..., R1...>(target: (A1...) -> R1...) -> boolean),
	get_root_callback: (() -> ((...any) -> ...any)?),
	is_hook_thread: (() -> boolean),
	get_original_thread: (() -> thread?),
}

-- LuaStateProxy Library
declare class LuaStateProxy
	Id: number
	IsActorState: boolean
	Event: VoltSignal<>
	function GetActors(self): { Actor }
	Execute: (<A...>(self: LuaStateProxy, source: string, A...) -> ())
end

declare function getactorstates(): { LuaStateProxy }
declare function getluastate(actor_or_script: (Actor | BaseScript)?): LuaStateProxy
...
declare DrawingImmediate: {
	...
	Text: (position: Vector2, font: DrawFont | number, font_size: number, color: Color3, opacity: number, text: string, center: boolean) -> (),
	OutlinedText: (position: Vector2, font: DrawFont | number, font_size: number, color: Color3, opacity: number, outline_color: Color3, outline_opacity: number, text: string, center: boolean) -> (),
	GetPaint: (z_index: number?) -> VoltSignal<>,
	Fonts: DrawingFonts
}
...
declare class RakNetPacket
	...
	Size: number
	function SetData(self, data: buffer | string | {number}): ()
	function Block(self)
end

export type RakNetHook = (packet: RakNetPacket) -> ()

declare raknet: {
	add_send_hook: (hook: RakNetHook) -> (),
	remove_send_hook: (hook: RakNetHook) -> (),
